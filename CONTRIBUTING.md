...
- [ ] If Windows/Arabic install affected: [docs/INSTALLATION_AR.md](docs/INSTALLATION_AR.md)
...
4. README and PROJECT_DESCRIPTION project trees list all `docs/` files and launchers.
